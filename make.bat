...
:dev
	echo %PWD%
	@docker run --rm -v %PWD%:/app -p 0.0.0.0:8000:8000 -p 0.0.0.0:8001:8001 -it %IMAGE% adev runserver --livereload --host 0.0.0.0 --port 8000 run.py
	GOTO :EOF

:run
	@docker run --rm %IMAGE% -it -p 0.0.0.0:8000:8000 %IMAGE%
	GOTO :EOF
